 ...
 */
inline void multiplyWithKaratsuba(uint64_t operand1, uint64_t operand2, uint64_t *result128) {
  ...
  uint64_t right = b * d;
  uint64_t middle;
  uint64_t left = a * c + (static_cast<uint64_t>(addWithCarry(a * d, b * c, 0, &middle)) << 32);
