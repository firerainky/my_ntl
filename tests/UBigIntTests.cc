...
TEST(UBigIntTests, MultiplyTwoUnsignedBigInteger) {
  ...
  ASSERT_EQ(UBigInt("123456789012345678901234567890").multiply(UBigInt("1")).toString(), "123456789012345678901234567890");
  ASSERT_EQ(UBigInt("123456789012345678901234567890").multiply(UBigInt("0")).toString(), "0");
  ASSERT_EQ(UBigInt("123456789012345678901234567890").multiply(UBigInt("123456789012345678901234567890")).toString(), "15241578753238836750495351562536198787501905199875019052100");
  ASSERT_EQ(UBigInt("999999999999999999999999999999").multiply(UBigInt("999999999999999999999999999999")).toString(), "999999999999999999999999999998000000000000000000000000000001");
}
