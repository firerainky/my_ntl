...
TEST(AddWithCarryTests, AddWithCarry) {
  ...
  ASSERT_EQ(1ULL, result);
  ASSERT_FALSE(
      addWithCarry(0xF00F00F00F00F00FULL, 0x0FF0FF0FF0FF0FF0ULL, 0, &result));
  ASSERT_EQ(0xFFFFFFFFFFFFFFFFULL, result);
  ASSERT_TRUE(
      addWithCarry(0xF00F00F00F00F00FULL, 0x0FF0FF0FF0FF0FF0ULL, 1, &result));
...
TEST(SubWithBorrowTests, SubWithBorrow) {
  ...
  ASSERT_EQ(3ULL, result);
  ASSERT_FALSE(
      subWithBorrow(0xF00F00F00F00F00FULL, 0x0FF0FF0FF0FF0FF0ULL, 0, &result));
  ASSERT_EQ(0xE01E01E01E01E01FULL, result);
  ASSERT_FALSE(
      subWithBorrow(0xF00F00F00F00F00FULL, 0x0FF0FF0FF0FF0FF0ULL, 1, &result));
